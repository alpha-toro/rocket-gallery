...
$settings['rocketgallery.use_richtext']= $modx->newObject('modSystemSetting');
$settings['rocketgallery.use_richtext']->fromArray(array(
    'key' => 'rocketgallery.use_richtext',
    'value' => true,
    'xtype' => 'combo-boolean',
    'namespace' => 'rocketgallery',
    'area' => 'editor',
),'',true,true);
