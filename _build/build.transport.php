...
} else { $modx->log(modX::LOG_LEVEL_FATAL,'Could not package in chunks.'); }
...
if (empty($menu)) {
    ...
    $vehicle->resolve('php', array(
        'source' => $sources['resolvers'] . 'resolve.files.php',
    ));
    $builder->putVehicle($vehicle);
