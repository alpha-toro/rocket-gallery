 ...
 */
/**
 * The base class for rocketgallery.
 *
...
class RocketGallery {
    ...
    public function __construct(modX &$modx,array $config = array()) {
        ...
        $corePath = $this->modx->getOption('rocketgallery.core_path',$config,$this->modx->getOption('core_path').'components/rocketgallery/');
        $assetsUrl = $this->modx->getOption('rocketgallery.assets_url',$config,$this->modx->getOption('assets_url').'components/rocketgallery/');
        ...
        $this->modx->addPackage('rocketgallery',$this->config['modelPath']);
        $this->modx->lexicon->load('rocketgallery:default');
    }
